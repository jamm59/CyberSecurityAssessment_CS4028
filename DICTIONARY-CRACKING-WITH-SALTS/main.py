...
for saltedHashedPassword, saltKey in inputHashedAndSaltedPair:
    for password in passwordList:
        ...
        hashedTable[hashedPasswordLeft] = password
        hashedTable[hashedPasswordRight] = password



results = []
for saltedHashedPassword, saltKey in inputHashedAndSaltedPair:
    if saltedHashedPassword in hashedTable:
        results.append(hashedTable[saltedHashedPassword])
